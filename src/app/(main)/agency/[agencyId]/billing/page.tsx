    ...
    <>
      ...
      <div className="flex flex-col lg:!flex-row justify-between gap-8">
        <PricingCard
          ...
          highlightDescription="Want to change your plan? You can do this here. If you have
          further question contact madavhabaldwin@gmail.com"
          highlightTitle="Plan Options"
          description={
            agencySubscription?.Subscription?.active === true
              ? currentPlanDetails?.description || 'Lets get started'
              : 'Get started by choosing a plan that works best for you.'
          }
          duration="/ month"
          features={
            agencySubscription?.Subscription?.active === true
